...
public class NumberOfDays {
    ...
    public static void main(String[] args) {
        ...
        boolean has28Days = number == 2; // for months with 28 days
        boolean has30Days = number == 4 || number == 6 || number == 9 || number == 11; // for months with 30 days
        boolean has31Days = !has28Days && !has30Days; // if the month does not have 28 or 30 days
